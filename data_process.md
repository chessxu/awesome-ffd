...
# 一、数据集下载
## 1,FaceForensics++
①在官方的[链接](https://github.com/ondyari/FaceForensics?tab=readme-ov-file)中，您可以通过填写谷歌表单的方式向官方递交申请，如果申请通过会将下载脚本自动的发送到你的邮箱中。

②这里也为您提供了下载脚本的代码，如果需要可以直接复制到python文件中。
```
#!/usr/bin/env python
...
①[Celeb-DF-v1](https://drive.google.com/file/d/10NGF38RgF8FZneKOuCOdRIsPzpC7_WDd/view)

②[Celeb-DF-v2](https://drive.google.com/file/d/1iLx76wsbi9itnkxSqz9BVBl4ZvnbIazj/view)
